...
import { FRONTEND_PORT, RESEND_API_KEY } from "../config/env.js"
...
const sendRegistrationCodeEmail = (email, registration_code) => {
    ...
    resend.emails.send({
        ...
        <h1><span style="text-decoration: underline;"><a href="http://localhost:${FRONTEND_PORT}/users/validate/${registration_code}">ACTIVAR</a></span></h1>
        <h2>¡Date prisa!</h2>
